 ...
 * @author Noah Sun
 * @email 
 * @create date 2017-09-30 05:13:52
 * @modify date 2017-09-30 05:13:52
 * @desc 桥接模式
 * 把抽象概念和具体实现分离开来，让这两部分可以完全独立的变化
*/

let RemoteControl = function (tv) {
    this.tv = tv;
